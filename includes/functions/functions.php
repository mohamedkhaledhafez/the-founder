      ...
      */
       ...
       */
        ...
        */
        ...
        function getLatest($select, $table, $order, $limit = 50) {
            global $con;

            $getStatment = $con->prepare("SELECT $select FROM $table ORDER BY $order ASC LIMIT $limit");
        ...
        ** $limit  = Number of records that will be fetched from users
        */
        function getLatestMessage($select, $table, $where, $and, $order) {
            global $con;

            $getStatment = $con->prepare("SELECT $select FROM $table $where $and ORDER BY $order DESC");
        ...
        function getServices($select, $table, $where, $order) {
            global $con;

            $getStatment = $con->prepare("SELECT $select FROM $table $where ORDER BY $order DESC");
        ...
        function countMessages($msg, $table, $where, $and) {

            global $con;
            
            $stmt2 = $con->prepare("SELECT COUNT($msg) FROM $table $where $and");
